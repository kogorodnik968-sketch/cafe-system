...
public class CustomerServiceTest {
    ...
    void create_shouldSaveAndReturnDto() {
        CustomerRequestDto dto = new CustomerRequestDto("Ivan", "Ivanov", "Ivanovich", "+123456789012", "string", "ivan@gmail.com", "123456");
    ...
    void create_shouldThrow_whenExists() {
        CustomerRequestDto dto = new CustomerRequestDto("A", "B", "C", "+123456789012", "url", "name@gmail.com", "111111");
